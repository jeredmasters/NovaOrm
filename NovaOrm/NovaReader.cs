...
namespace NovaOrm
{
    public class NovaReader : NovaOrm.INovaReader, IEnumerable<NovaEntity>
    {
        ...
        public NovaReader(string[] columnNames, NovaSmoothing smoothing = null)
        {
        ...
        public string ToCsv()
        {
            ...
            foreach(NovaEntity row in this){
                ...
                lines.Add(StringHelpers.SeperateByComma(cells.ToArray()));
            }
